...
function trimString(original, side) {
  if (side === "start") {
    // Використовуємо метод trimStart(), щоб видалити пробіли на початку рядка
    return original.trimStart();
  } else if (side === "end") {
    // Використовуємо метод trimEnd(), щоб видалити пробіли в кінці рядка
    return original.trimEnd();
  } else if (side === "both") {
    // Використовуємо метод trim(), щоб видалити пробіли з обох сторін рядка
...
function convertCase(original, caseType) {
  if (caseType === "upper") {
    // Використовуємо метод toUpperCase(), щоб перетворити всі букви в верхній регістр
    return original.toUpperCase();
  } else if (caseType === "lower") {
    // Використовуємо метод toLowerCase(), щоб перетворити всі букви в нижній регістр
